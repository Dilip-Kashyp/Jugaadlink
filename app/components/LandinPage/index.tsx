  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-6 pb-20">
      ...
      <div className="text-center py-16 md:py-24">
        ...
        <h1 className="text-5xl md:text-7xl font-black font-heading tracking-tight leading-[1.05] mb-6 text-[var(--foreground)]">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Button
            ...
            className="!h-13 !px-8 !text-base !font-bold !rounded-xl !shadow-lg hover:!shadow-xl transition-shadow flex items-center gap-2"
          >
